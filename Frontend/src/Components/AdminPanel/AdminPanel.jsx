...
const AdminPanel = ({isDarkMode}) => {
  ...
  const fetchBackgroundMedia = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_BASE_URL}/api/upload-background`);
  ...
  const handleUpload = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_BASE_URL}/api/upload-background`,
        formData,
        {
  ...
  const handleDelete = async () => {
    try {
      const response = await axios.delete(`${import.meta.env.VITE_BACKEND_BASE_URL}/api/upload-background`);
