...
const AddWork = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3000/postart', formData, {
                headers: {
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6 gap-y-8">
                            ...
                            <div className="w-full md:w-1/2 px-3 gap-y-8">
                                <div className="w-full px-3 mb-6 md:mb-0">
                                    <label className="block uppercase tracking-wide text-white text-xs font-bold mb-2" htmlFor="grid-art-name">
                                        Art Name
                                    </label>
                                    <input
                                ...
                                <div className="w-full px-3 mb-6 md:mb-0">
                                    ...
                                    />
                                    {/* artvediolink */}
                                    <label className="block uppercase tracking-wide text-white text-xs font-bold mb-2" htmlFor="grid-videolink">
                                        videolink
                                    </label>
                                    <input
                                        className="appearance-none block w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                            ...
                            <div className="w-full md:w-1/2 px-3 gap-y-8">
                                ...
                                <div className="mt-4">
                                    {filePreviews.map((preview, index) => (
                                        <img key={index} src={preview} alt={`Preview ${index}`} className="w-20 h-20 object-cover m-2" />
                                    ))}
                                </div>
                            </div>
                        </div>
